...
words_path = os.path.join("resources", "resources/words.txt")
text_path = os.path.join("resources", "resources/input.txt")
output_file_path = os.path.join("resources", "resources/text.txt")
